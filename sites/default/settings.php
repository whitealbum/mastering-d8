 ...
 * @endcode
 */
$settings['hash_salt'] = 'ztRm5ozg4s0w11mmRf9ECtiDwCkkbVCCLIVP2aCQ8na8so85qGvLRQ9mPoco6SDy5AEb5tE66A';
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/hiscoxus/hiscoxus-settings.inc';
}
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    ...
    case 'livedev':
      // dev settings
      $settings['hiscox_qb_domain'] = 'uat.quote.hiscox.com';
      $settings['hiscox_api_base_url'] = 'https://hiscox-us-sdbx.apigee.net/toolbox/';
      $settings['hiscox_tealium_id'] = 'drupal-production';
      break;
    ...
    case 'preprod':
      ...
      $settings['hiscox_qb_domain'] = 'quote.hiscox.com';
      $settings['hiscox_api_base_url'] = 'https://hiscox-us-prod.apigee.net/toolbox/';
      $settings['hiscox_tealium_id'] = 'drupal-production';
      break;
